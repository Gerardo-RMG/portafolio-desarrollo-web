...
public class Registro {
    ...
    public Registro(String matricula, String nombre, String materia, String p1, String p2, String p3) {
        this.matricula = matricula;
        this.nombre    = nombre;
        this.materia   = materia;
        this.p1 = Double.parseDouble(p1.replace(",", "."));
        this.p2 = Double.parseDouble(p2.replace(",", "."));
        this.p3 = Double.parseDouble(p3.replace(",", "."));
    }
